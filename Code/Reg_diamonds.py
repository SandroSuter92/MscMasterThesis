...
#Transform various categorical columns into numerical values
_cut = []
cut = df['cut']
...
for i in range(500):
    samples.append(np.random.randint(0, 53939))
...
for i in range(4):
    ...
    X_train, X_test, y_train, y_test = train_test_split(df_sample[['carat', 'depth',
                                                                   'table', 'x',
                                                                   'y', 'z',
                                                                   '_cut', '_color']],
                                                        df_sample['price'],
    ...
    #Set path to store ouputs
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GPB/diamonds/outputs.csv"
...
for i in range(4):
    ...
    #Check wether path is existing or not & creating needed folders, if not existing
    path = "models/randomForrest/diamonds"
    ...
    #Set path to store output
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/randomForrest/diamonds/outputs.csv"
...
for i in range(4):
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GP/diamonds/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store outputs
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/Boosting/diamonds/outputs.csv"
