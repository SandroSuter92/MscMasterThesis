...
path_ucl = path + '/ucl_stats.csv'

#Data load
df_ucl = pd.read_csv(path_ucl)

#Change Variable team into numerical values
teams = list(df_ucl['team'])
int_teams = []
for i in range(len(teams)):
    int_teams.append(i)
dict_teams = dict(zip(teams, int_teams))

_teams = []
for team in teams:
    _teams.append(dict_teams[team])

df_ucl['_teams'] = _teams
...
for i in range(500):
    samples.append(np.random.randint(0, 713))
...
for i in range(4):
    ...
    X_train, X_test, y_train, y_test = train_test_split(df_sample[['match_played','wins', 'draws',
                                                                'losts', 'goals_scored',
    ...
    #Normalize data
    col_X_train = ['match_played','wins', 'draws',
                   'losts', 'goals_scored',
                   'goals_conceded', 'gd', 'group_point']
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GPB/UCL/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store output-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/randomForrest/UCL/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store output-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GP/UCL/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store output-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/Boosting/UCL/outputs.csv"
