...
path_smoking = path + '/smoking.csv'

#Load data
df_smoking = pd.read_csv(path_smoking)

#Transform various categorical variables to numerical values
gender = df_smoking['gender']
_gender = []
for i in gender:
    if i == 'F':
        _gender.append(1)
        ...
        _gender.append(2)
df_smoking['_gender'] = _gender

oral = df_smoking['oral']
_oral = []
for i in oral:
    _oral.append(1)
df_smoking['_oral'] = _oral

tartar = df_smoking['tartar']
_tartar = []
for i in tartar:
    if i == 'Y':
        _tartar.append(1)
        ...
        _tartar.append(2)
df_smoking['_tartar'] = _tartar

#Drop all NA-Values
df_smoking = df_smoking.dropna()
...
for i in range(500):
    samples.append(np.random.randint(0, 55691))
df_sample_1 = df_smoking.iloc[samples]
...
for i in range(500):
    samples.append(np.random.randint(0, 55691))
df_sample_2 = df_smoking.iloc[samples]
...
for i in range(500):
    samples.append(np.random.randint(0, 55691))
df_sample_3 = df_smoking.iloc[samples]
...
for i in range(500):
    samples.append(np.random.randint(0, 55691))
df_sample_4 = df_smoking.iloc[samples]
...
#4-fold CrossValidation GPBoost
for i in range(4):
    ...
    X_train, X_test, y_train, y_test = train_test_split(df_sample[['age', 'height(cm)',
                                                                   'weight(kg)', 'waist(cm)',
    ...
    #Transform predictions in 0 an d 1 values
    predictions = []
    ...
    #Set path to store outputs-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GPB/Smoking/outputs.csv"
...
for i in range(4):
    ...
    # Check wether path is existing or not & creating needed folders, if not existing
    path = "models/randomForrest/Smoking"
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/randomForrest/Smoking/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store outputs-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GP/Smoking/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store output-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/Boosting/Smoking/outputs.csv"
