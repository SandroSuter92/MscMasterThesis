...
path_wine_white = path + '/data/winequality-white.csv'

df_wine_white = pd.read_csv(path_wine_white, delimiter=';')

name_col = {'fixed acidity': 'fixed_acidity',
...
df_wine_white = df_wine_white.rename(columns=name_col)

samples = []
sample_seed = np.random.randint(0, 100)
np.random.seed(sample_seed)
for i in range(500):
    samples.append(np.random.randint(0, 4898))
df_sample_1 = df_wine_white.iloc[samples]
...
for i in range(500):
    samples.append(np.random.randint(0, 4898))
df_sample_2 = df_wine_white.iloc[samples]
...
for i in range(500):
    samples.append(np.random.randint(0,4898))
df_sample_3 = df_wine_white.iloc[samples]
...
for i in range(500):
    samples.append(np.random.randint(0, 4898))
df_sample_4 = df_wine_white.iloc[samples]
...
for i in range(4):
    ...
    X_train, X_test, y_train, y_test = train_test_split(df_sample[['fixed_acidity',
                                                                       'volatile_acidity',
                                                                       'citric_acid',
                                                                       'residual_sugar',
                                                                       'chlorides',
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GPB/WineWhite/outputs.csv"
...
for i in range(4):
    ...
    #Check wether path is existing or not & creating needed folders, if not existing
    path = "models/randomForrest/WineWhite"
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/randomForrest/WineWhite/outputs.csv"
...
for i in range(4):
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GP/WineWhite/outputs.csv"
...
for i in range(4):
    ...
    # Check wether path is existing or not & creating needed folders, if not existing
    path = "models/Boosting/WineWhite"
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/Boosting/WineWhite/outputs.csv"
