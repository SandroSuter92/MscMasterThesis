...
path_cancer = path + '/cancer_data.csv'

#Load data
df_cancer = pd.read_csv(path_cancer, header=None)


#Rename columns
col_name = ['Id', 'Clumb_Thickness', 'Uniformity_of_Cell_Size', 'Uniformity_of_Cell_Shape',
...
dict_rename = dict(zip(list_key, col_name))
...
df_cancer = df_cancer.rename(columns=dict_rename)

#Transform Class variable into 0 and 1 values
_Class = []

for i in df_cancer['Class']:
    if i == 2:
        _Class.append(0)
    else:
        _Class.append(1)

df_cancer['_Class'] = _Class

df=df_cancer

#Create randomly 4 samples
samples = []
sample_seed = np.random.randint(0, 100)
np.random.seed(sample_seed)
for i in range(500):
    samples.append(np.random.randint(0, 698))
...
for i in range(4):
    ...
    X_train, X_test, y_train, y_test = train_test_split(df_sample[['Clumb_Thickness', 'Uniformity_of_Cell_Size', 'Uniformity_of_Cell_Shape',
    ...
    #Normalize data
    col_X_train = ['Clumb_Thickness', 'Uniformity_of_Cell_Size', 'Uniformity_of_Cell_Shape',
           'Marginal_Adhesion', 'Single_Epithelial_Cell_Size', 'Bland_Chromatin',
           'Normal_Nucleoli', 'Mitoses']
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GPB/Cancer/outputs.csv"
...
for i in range(4):
    ...
    # Check wether path is existing or not & creating needed folders, if not existing
    path = "models/randomForrest/Cancer"
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        df_sample[['Clumb_Thickness', 'Uniformity_of_Cell_Size', 'Uniformity_of_Cell_Shape',
                   'Marginal_Adhesion', 'Single_Epithelial_Cell_Size', 'Bland_Chromatin',
                   'Normal_Nucleoli', 'Mitoses']],
                   df_sample['_Class'],
                   test_size=0.33,
    ...
    #Set path to store output-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/randomForrest/Cancer/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store output-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GP/Cancer/outputs.csv"
...
for i in range(4):
    ...
    #Set path to store output-file
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/Boosting/Cancer/outputs.csv"
