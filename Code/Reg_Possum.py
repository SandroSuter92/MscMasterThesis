...
path_possum = path + '/possum.csv'

#Load data
df_possum = pd.read_csv(path_possum)
...
#4-fold CrossValidation for GPB
for i in range(4):
    ...
    X_train, X_test, y_train, y_test = train_test_split(df_possum[['site', '_pop', '_sex', 'hdlngth',
    ...
    # Normalize data
    col_X_train = ['site', '_pop', '_sex', 'hdlngth',
                   'skullw', 'totlngth', 'taill', 'footlgth',
                   'earconch', 'eye', 'chest', 'belly']
    ...
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GPB/possum/outputs.csv"
...
for i in range(4):
    ...
    #Check wether path is existing or not & creating needed folders, if not existing
    path = "models/randomForrest/possum"
    ...
    # Set path to store outputs
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/randomForrest/possum/outputs.csv"
...
for i in range(4):
    ...
    # Set path to store outputs
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/GP/possum/outputs.csv"
...
for i in range(4):
    ...
    # Set path to store outputs
    path = "C:/Users/localadmin/Desktop/Thesis/Code/models/Boosting/possum/outputs.csv"
